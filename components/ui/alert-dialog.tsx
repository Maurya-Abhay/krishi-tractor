...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    ...
    className={cn(
      ...
      "data-[state=open]:animate-fade-in data-[state=closed]:animate-fade-in data-[state=closed]:[animation-direction:reverse]",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Portal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed z-50 border border-border bg-card p-5 shadow-elev-4 focus:outline-none sm:p-6",
        "inset-x-0 bottom-0 rounded-t-3xl pb-[calc(1.25rem+env(safe-area-inset-bottom,0px))]",
        ...
        "sm:data-[state=open]:animate-enter sm:data-[state=closed]:animate-zoom-out",
        className
      )}
      {...props}
    />
